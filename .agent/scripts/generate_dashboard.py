"""
generate_dashboard.py — Enhanced Pipeline Progress Dashboard for Visuals
========================================================================
Generates a self-contained HTML dashboard with:
  - Overall progress & pass rate
  - Statistical distributions (timing, CoT size, answer size)
...
<head>
    ...
    <title>Visual Tasks Pipeline Dashboard</title>
    ...
    <div class="task-table-wrapper">
        <table>
            <thead>
                <tr>
                    <th>Task</th>
                    <th>CoT</th><th>Answer</th>
                    <th>Time</th><th>Attempts</th>
                    <th>Repair</th><th>Fixes Applied</th>
                </tr>
            </thead>
            <tbody>
                {task_rows if task_rows else '<tr><td colspan="7" class="no-data">No task data yet.</td></tr>'}
            </tbody>
        </table>
    </div>
